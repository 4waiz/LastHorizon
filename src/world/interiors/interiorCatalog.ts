...
const HOME: InteriorDef = {
  ...
  points: [
    ...
    { id: 'home_chair', kind: 'chair', x: 0.35, z: 1.4, y: 0.5, radius: 1.2, prompt: 'Sit down' },
...
const CAFE: InteriorDef = {
  ...
  points: [
    ...
    { id: 'cafe_seat_a', kind: 'chair', x: 2.6, y: 0.5, z: 0.2, radius: 1.1, prompt: 'Take a seat' },
    { id: 'cafe_seat_b', kind: 'chair', x: 2.9, y: 0.5, z: 2.2, radius: 1.1, prompt: 'Take a seat' },
  ],
